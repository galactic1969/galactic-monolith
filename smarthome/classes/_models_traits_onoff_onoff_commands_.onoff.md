[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/traits/onoff/onoff_commands"](../modules/_models_traits_onoff_onoff_commands_.md) › [OnOff](_models_traits_onoff_onoff_commands_.onoff.md)
...
* [constructor](_models_traits_onoff_onoff_commands_.onoff.md#constructor)

### Properties

* [name](_models_traits_onoff_onoff_commands_.onoff.md#name)
* [param](_models_traits_onoff_onoff_commands_.onoff.md#param)
* [_name](_models_traits_onoff_onoff_commands_.onoff.md#static-_name)

### Methods

* [askAcknowledgment](_models_traits_onoff_onoff_commands_.onoff.md#askacknowledgment)
* [askPinCode](_models_traits_onoff_onoff_commands_.onoff.md#askpincode)
* [checkAcknowledgement](_models_traits_onoff_onoff_commands_.onoff.md#checkacknowledgement)
* [checkChallenge](_models_traits_onoff_onoff_commands_.onoff.md#checkchallenge)
* [checkPinCode](_models_traits_onoff_onoff_commands_.onoff.md#checkpincode)
* [execute](_models_traits_onoff_onoff_commands_.onoff.md#execute)
* [getChallengeType](_models_traits_onoff_onoff_commands_.onoff.md#getchallengetype)
* [getKeyName](_models_traits_onoff_onoff_commands_.onoff.md#getkeyname)
* [getMaksedParam](_models_traits_onoff_onoff_commands_.onoff.md#getmaksedparam)
* [getMergedStates](_models_traits_onoff_onoff_commands_.onoff.md#getmergedstates)
* [getName](_models_traits_onoff_onoff_commands_.onoff.md#getname)
* [getState](_models_traits_onoff_onoff_commands_.onoff.md#getstate)
* [hasChallengeType](_models_traits_onoff_onoff_commands_.onoff.md#haschallengetype)
* [isAlreadyInRequestedState](_models_traits_onoff_onoff_commands_.onoff.md#isalreadyinrequestedstate)
* [reportInvalidPinCode](_models_traits_onoff_onoff_commands_.onoff.md#reportinvalidpincode)
* [setState](_models_traits_onoff_onoff_commands_.onoff.md#setstate)
* [getKeyName](_models_traits_onoff_onoff_commands_.onoff.md#static-getkeyname)
* [getName](_models_traits_onoff_onoff_commands_.onoff.md#static-getname)

## Constructors

###  constructor

\+ **new OnOff**(`init`: Command["param"]): *[OnOff](_models_traits_onoff_onoff_commands_.onoff.md)*
...
**Returns:** *[OnOff](_models_traits_onoff_onoff_commands_.onoff.md)*

## Properties

###  name

• **name**: *"action.devices.commands.OnOff"* = OnOff._name
...
*Defined in [src/models/traits/onoff/onoff_commands.ts:10](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L10)*
...
▪ **_name**: *"action.devices.commands.OnOff"* = "action.devices.commands.OnOff"

*Overrides [Command](_models_core_.command.md).[_name](_models_core_.command.md#static-_name)*

*Defined in [src/models/traits/onoff/onoff_commands.ts:9](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L9)*
...
▸ **execute**(`trait`: [Trait](_models_core_.trait.md), `params`: [OnOff](../interfaces/_models_traits_i_commands_.onoff.md), `options`: IntentInterface.ExecuteRequestExecutionOption): *Promise‹[ExecuteResult](_models_intent_.executeresult.md)›*

*Overrides [Command](_models_core_.command.md).[execute](_models_core_.command.md#abstract-execute)*

*Defined in [src/models/traits/onoff/onoff_commands.ts:15](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L15)*
...
`params` | [OnOff](../interfaces/_models_traits_i_commands_.onoff.md) |
...
▸ **getState**(`trait`: [Trait](_models_core_.trait.md)): *[On](_models_traits_onoff_onoff_states_.on.md)*

*Overrides [Command](_models_core_.command.md).[getState](_models_core_.command.md#abstract-getstate)*

*Defined in [src/models/traits/onoff/onoff_commands.ts:31](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L31)*
...
▸ **isAlreadyInRequestedState**(`trait`: [Trait](_models_core_.trait.md), `params`: [OnOff](../interfaces/_models_traits_i_commands_.onoff.md)): *boolean*

*Defined in [src/models/traits/onoff/onoff_commands.ts:25](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L25)*
...
▸ **setState**(`trait`: [Trait](_models_core_.trait.md), `params`: [OnOff](../interfaces/_models_traits_i_commands_.onoff.md)): *VariableTrait["States"]*

*Overrides [Command](_models_core_.command.md).[setState](_models_core_.command.md#abstract-setstate)*

*Defined in [src/models/traits/onoff/onoff_commands.ts:35](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/onoff/onoff_commands.ts#L35)*
