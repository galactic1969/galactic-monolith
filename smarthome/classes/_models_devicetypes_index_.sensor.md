[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Sensor](_models_devicetypes_index_.sensor.md)
...
* [constructor](_models_devicetypes_index_.sensor.md#constructor)

### Properties

* [id](_models_devicetypes_index_.sensor.md#id)
* [name](_models_devicetypes_index_.sensor.md#name)
* [traits](_models_devicetypes_index_.sensor.md#traits)
* [typeName](_models_devicetypes_index_.sensor.md#typename)
* [willReportState](_models_devicetypes_index_.sensor.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.sensor.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.sensor.md#createid)
* [getCommand](_models_devicetypes_index_.sensor.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.sensor.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.sensor.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.sensor.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.sensor.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.sensor.md#format)

## Constructors

###  constructor

\+ **new Sensor**(`param?`: undefined | object): *[Sensor](_models_devicetypes_index_.sensor.md)*
...
**Returns:** *[Sensor](_models_devicetypes_index_.sensor.md)*
...
• **typeName**: *"action.devices.traits.SENSOR"* = "action.devices.traits.SENSOR"
...
*Defined in [src/models/devicetypes/index.ts:204](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L204)*
