[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Faucet](_models_devicetypes_index_.faucet.md)
...
* [constructor](_models_devicetypes_index_.faucet.md#constructor)

### Properties

* [id](_models_devicetypes_index_.faucet.md#id)
* [name](_models_devicetypes_index_.faucet.md#name)
* [traits](_models_devicetypes_index_.faucet.md#traits)
* [typeName](_models_devicetypes_index_.faucet.md#typename)
* [willReportState](_models_devicetypes_index_.faucet.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.faucet.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.faucet.md#createid)
* [getCommand](_models_devicetypes_index_.faucet.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.faucet.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.faucet.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.faucet.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.faucet.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.faucet.md#format)

## Constructors

###  constructor

\+ **new Faucet**(`param?`: undefined | object): *[Faucet](_models_devicetypes_index_.faucet.md)*
...
**Returns:** *[Faucet](_models_devicetypes_index_.faucet.md)*
...
• **typeName**: *"action.devices.types.FAUCET"* = "action.devices.types.FAUCET"
...
*Defined in [src/models/devicetypes/index.ts:96](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L96)*
