[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/traits/inputselector/inputselector"](../modules/_models_traits_inputselector_inputselector_.md) › [InputSelector](_models_traits_inputselector_inputselector_.inputselector.md)
...
* [InputSelectorTrait](../interfaces/_models_traits_i_traits_.inputselectortrait.md)

## Index

### Constructors

* [constructor](_models_traits_inputselector_inputselector_.inputselector.md#constructor)

### Properties

* [Attributes](_models_traits_inputselector_inputselector_.inputselector.md#attributes)
* [Commands](_models_traits_inputselector_inputselector_.inputselector.md#commands)
* [States](_models_traits_inputselector_inputselector_.inputselector.md#states)
* [name](_models_traits_inputselector_inputselector_.inputselector.md#name)

### Methods

* [getAttribute](_models_traits_inputselector_inputselector_.inputselector.md#getattribute)
* [getCommand](_models_traits_inputselector_inputselector_.inputselector.md#getcommand)
* [getElement](_models_traits_inputselector_inputselector_.inputselector.md#getelement)
* [getElements](_models_traits_inputselector_inputselector_.inputselector.md#getelements)
* [getKeyName](_models_traits_inputselector_inputselector_.inputselector.md#getkeyname)
* [getMergedAttributes](_models_traits_inputselector_inputselector_.inputselector.md#getmergedattributes)
* [getMergedStates](_models_traits_inputselector_inputselector_.inputselector.md#getmergedstates)
* [getState](_models_traits_inputselector_inputselector_.inputselector.md#getstate)
* [hasAttribute](_models_traits_inputselector_inputselector_.inputselector.md#hasattribute)
* [hasAttributes](_models_traits_inputselector_inputselector_.inputselector.md#hasattributes)
* [hasCommand](_models_traits_inputselector_inputselector_.inputselector.md#hascommand)
* [hasCommands](_models_traits_inputselector_inputselector_.inputselector.md#hascommands)
* [hasElement](_models_traits_inputselector_inputselector_.inputselector.md#haselement)
* [hasState](_models_traits_inputselector_inputselector_.inputselector.md#hasstate)
* [hasStates](_models_traits_inputselector_inputselector_.inputselector.md#hasstates)
* [shouldHaveAttributes](_models_traits_inputselector_inputselector_.inputselector.md#shouldhaveattributes)
* [shouldHaveCommands](_models_traits_inputselector_inputselector_.inputselector.md#shouldhavecommands)
* [shouldHaveElements](_models_traits_inputselector_inputselector_.inputselector.md#shouldhaveelements)
* [shouldHaveStates](_models_traits_inputselector_inputselector_.inputselector.md#shouldhavestates)
* [toJsonObject](_models_traits_inputselector_inputselector_.inputselector.md#tojsonobject)
* [validate](_models_traits_inputselector_inputselector_.inputselector.md#validate)
* [getKeyName](_models_traits_inputselector_inputselector_.inputselector.md#static-getkeyname)
* [getName](_models_traits_inputselector_inputselector_.inputselector.md#static-getname)
* [init](_models_traits_inputselector_inputselector_.inputselector.md#static-init)
* [initWithJson](_models_traits_inputselector_inputselector_.inputselector.md#static-initwithjson)
* [resolveAttributes](_models_traits_inputselector_inputselector_.inputselector.md#static-resolveattributes)
* [resolveCommands](_models_traits_inputselector_inputselector_.inputselector.md#static-resolvecommands)
* [resolveStates](_models_traits_inputselector_inputselector_.inputselector.md#static-resolvestates)

## Constructors

###  constructor

\+ **new InputSelector**(`param`: [InputSelectorParam](../interfaces/_models_traits_i_traits_.inputselectorparam.md)): *[InputSelector](_models_traits_inputselector_inputselector_.inputselector.md)*

*Overrides [Trait](_models_core_.trait.md).[constructor](_models_core_.trait.md#constructor)*

*Defined in [src/models/traits/inputselector/inputselector.ts:10](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/inputselector/inputselector.ts#L10)*

**Parameters:**

Name | Type |
------ | ------ |
`param` | [InputSelectorParam](../interfaces/_models_traits_i_traits_.inputselectorparam.md) |

**Returns:** *[InputSelector](_models_traits_inputselector_inputselector_.inputselector.md)*
...
*Implementation of [InputSelectorTrait](../interfaces/_models_traits_i_traits_.inputselectortrait.md).[Attributes](../interfaces/_models_traits_i_traits_.inputselectortrait.md#attributes)*
...
*Implementation of [InputSelectorTrait](../interfaces/_models_traits_i_traits_.inputselectortrait.md).[Commands](../interfaces/_models_traits_i_traits_.inputselectortrait.md#commands)*
...
*Implementation of [InputSelectorTrait](../interfaces/_models_traits_i_traits_.inputselectortrait.md).[States](../interfaces/_models_traits_i_traits_.inputselectortrait.md#states)*
...
• **name**: *"action.devices.traits.InputSelector"* = "action.devices.traits.InputSelector"

*Implementation of [InputSelectorTrait](../interfaces/_models_traits_i_traits_.inputselectortrait.md).[name](../interfaces/_models_traits_i_traits_.inputselectortrait.md#name)*
...
*Defined in [src/models/traits/inputselector/inputselector.ts:19](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/inputselector/inputselector.ts#L19)*
...
▸ **init**(`param`: [VariableTrait](../interfaces/_models_interfaces_i_core_.variabletrait.md)): *[InputSelector](_models_traits_inputselector_inputselector_.inputselector.md)*

*Overrides [Trait](_models_core_.trait.md).[init](_models_core_.trait.md#static-init)*

*Defined in [src/models/traits/inputselector/inputselector.ts:15](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/inputselector/inputselector.ts#L15)*
