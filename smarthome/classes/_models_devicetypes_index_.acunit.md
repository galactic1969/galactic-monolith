[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [AcUnit](_models_devicetypes_index_.acunit.md)
...
* [constructor](_models_devicetypes_index_.acunit.md#constructor)

### Properties

* [id](_models_devicetypes_index_.acunit.md#id)
* [name](_models_devicetypes_index_.acunit.md#name)
* [traits](_models_devicetypes_index_.acunit.md#traits)
* [typeName](_models_devicetypes_index_.acunit.md#typename)
* [willReportState](_models_devicetypes_index_.acunit.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.acunit.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.acunit.md#createid)
* [getCommand](_models_devicetypes_index_.acunit.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.acunit.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.acunit.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.acunit.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.acunit.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.acunit.md#format)

## Constructors

###  constructor

\+ **new AcUnit**(`param?`: undefined | object): *[AcUnit](_models_devicetypes_index_.acunit.md)*
...
**Returns:** *[AcUnit](_models_devicetypes_index_.acunit.md)*
...
• **typeName**: *"action.devices.types.AC_UNIT"* = "action.devices.types.AC_UNIT"
...
*Defined in [src/models/devicetypes/index.ts:4](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L4)*
