[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/traits/scene/scene_commands"](../modules/_models_traits_scene_scene_commands_.md) › [ActivateScene](_models_traits_scene_scene_commands_.activatescene.md)
...
* [constructor](_models_traits_scene_scene_commands_.activatescene.md#constructor)

### Properties

* [name](_models_traits_scene_scene_commands_.activatescene.md#name)
* [param](_models_traits_scene_scene_commands_.activatescene.md#param)
* [_name](_models_traits_scene_scene_commands_.activatescene.md#static-_name)

### Methods

* [askAcknowledgment](_models_traits_scene_scene_commands_.activatescene.md#askacknowledgment)
* [askPinCode](_models_traits_scene_scene_commands_.activatescene.md#askpincode)
* [checkAcknowledgement](_models_traits_scene_scene_commands_.activatescene.md#checkacknowledgement)
* [checkChallenge](_models_traits_scene_scene_commands_.activatescene.md#checkchallenge)
* [checkPinCode](_models_traits_scene_scene_commands_.activatescene.md#checkpincode)
* [execute](_models_traits_scene_scene_commands_.activatescene.md#execute)
* [getChallengeType](_models_traits_scene_scene_commands_.activatescene.md#getchallengetype)
* [getKeyName](_models_traits_scene_scene_commands_.activatescene.md#getkeyname)
* [getMaksedParam](_models_traits_scene_scene_commands_.activatescene.md#getmaksedparam)
* [getMergedStates](_models_traits_scene_scene_commands_.activatescene.md#getmergedstates)
* [getName](_models_traits_scene_scene_commands_.activatescene.md#getname)
* [getState](_models_traits_scene_scene_commands_.activatescene.md#getstate)
* [hasChallengeType](_models_traits_scene_scene_commands_.activatescene.md#haschallengetype)
* [reportInvalidPinCode](_models_traits_scene_scene_commands_.activatescene.md#reportinvalidpincode)
* [setState](_models_traits_scene_scene_commands_.activatescene.md#setstate)
* [getKeyName](_models_traits_scene_scene_commands_.activatescene.md#static-getkeyname)
* [getName](_models_traits_scene_scene_commands_.activatescene.md#static-getname)

## Constructors

###  constructor

\+ **new ActivateScene**(`init`: Command["param"]): *[ActivateScene](_models_traits_scene_scene_commands_.activatescene.md)*
...
**Returns:** *[ActivateScene](_models_traits_scene_scene_commands_.activatescene.md)*

## Properties

###  name

• **name**: *"action.devices.commands.ActivateScene"* = ActivateScene._name
...
*Defined in [src/models/traits/scene/scene_commands.ts:10](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/scene/scene_commands.ts#L10)*
...
▪ **_name**: *"action.devices.commands.ActivateScene"* = "action.devices.commands.ActivateScene"

*Overrides [Command](_models_core_.command.md).[_name](_models_core_.command.md#static-_name)*

*Defined in [src/models/traits/scene/scene_commands.ts:9](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/scene/scene_commands.ts#L9)*
...
▸ **execute**(`trait`: [Trait](_models_core_.trait.md), `params`: [ActivateScene](../interfaces/_models_traits_i_commands_.activatescene.md), `options`: IntentInterface.ExecuteRequestExecutionOption): *Promise‹[ExecuteResult](_models_intent_.executeresult.md)›*

*Overrides [Command](_models_core_.command.md).[execute](_models_core_.command.md#abstract-execute)*

*Defined in [src/models/traits/scene/scene_commands.ts:15](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/scene/scene_commands.ts#L15)*
...
`params` | [ActivateScene](../interfaces/_models_traits_i_commands_.activatescene.md) |
...
▸ **getState**(`trait`: [Trait](_models_core_.trait.md)): *null*

*Overrides [Command](_models_core_.command.md).[getState](_models_core_.command.md#abstract-getstate)*

*Defined in [src/models/traits/scene/scene_commands.ts:26](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/scene/scene_commands.ts#L26)*
...
▸ **setState**(`trait`: [Trait](_models_core_.trait.md), `params`: [ActivateScene](../interfaces/_models_traits_i_commands_.activatescene.md)): *Trait["States"]*

*Overrides [Command](_models_core_.command.md).[setState](_models_core_.command.md#abstract-setstate)*

*Defined in [src/models/traits/scene/scene_commands.ts:32](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/scene/scene_commands.ts#L32)*
