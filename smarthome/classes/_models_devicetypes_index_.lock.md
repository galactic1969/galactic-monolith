[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Lock](_models_devicetypes_index_.lock.md)
...
* [constructor](_models_devicetypes_index_.lock.md#constructor)

### Properties

* [id](_models_devicetypes_index_.lock.md#id)
* [name](_models_devicetypes_index_.lock.md#name)
* [traits](_models_devicetypes_index_.lock.md#traits)
* [typeName](_models_devicetypes_index_.lock.md#typename)
* [willReportState](_models_devicetypes_index_.lock.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.lock.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.lock.md#createid)
* [getCommand](_models_devicetypes_index_.lock.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.lock.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.lock.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.lock.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.lock.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.lock.md#format)

## Constructors

###  constructor

\+ **new Lock**(`param?`: undefined | object): *[Lock](_models_devicetypes_index_.lock.md)*
...
**Returns:** *[Lock](_models_devicetypes_index_.lock.md)*
...
• **typeName**: *"action.devices.types.LOCK"* = "action.devices.types.LOCK"
...
*Defined in [src/models/devicetypes/index.ts:140](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L140)*
