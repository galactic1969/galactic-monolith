[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [CoffeeMaker](_models_devicetypes_index_.coffeemaker.md)
...
* [constructor](_models_devicetypes_index_.coffeemaker.md#constructor)

### Properties

* [id](_models_devicetypes_index_.coffeemaker.md#id)
* [name](_models_devicetypes_index_.coffeemaker.md#name)
* [traits](_models_devicetypes_index_.coffeemaker.md#traits)
* [typeName](_models_devicetypes_index_.coffeemaker.md#typename)
* [willReportState](_models_devicetypes_index_.coffeemaker.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.coffeemaker.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.coffeemaker.md#createid)
* [getCommand](_models_devicetypes_index_.coffeemaker.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.coffeemaker.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.coffeemaker.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.coffeemaker.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.coffeemaker.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.coffeemaker.md#format)

## Constructors

###  constructor

\+ **new CoffeeMaker**(`param?`: undefined | object): *[CoffeeMaker](_models_devicetypes_index_.coffeemaker.md)*
...
**Returns:** *[CoffeeMaker](_models_devicetypes_index_.coffeemaker.md)*
...
• **typeName**: *"action.devices.types.COFFEE_MAKER"* = "action.devices.types.COFFEE_MAKER"
...
*Defined in [src/models/devicetypes/index.ts:56](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L56)*
