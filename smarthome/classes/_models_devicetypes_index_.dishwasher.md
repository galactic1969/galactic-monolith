[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Dishwasher](_models_devicetypes_index_.dishwasher.md)
...
* [constructor](_models_devicetypes_index_.dishwasher.md#constructor)

### Properties

* [id](_models_devicetypes_index_.dishwasher.md#id)
* [name](_models_devicetypes_index_.dishwasher.md#name)
* [traits](_models_devicetypes_index_.dishwasher.md#traits)
* [typeName](_models_devicetypes_index_.dishwasher.md#typename)
* [willReportState](_models_devicetypes_index_.dishwasher.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.dishwasher.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.dishwasher.md#createid)
* [getCommand](_models_devicetypes_index_.dishwasher.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.dishwasher.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.dishwasher.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.dishwasher.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.dishwasher.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.dishwasher.md#format)

## Constructors

###  constructor

\+ **new Dishwasher**(`param?`: undefined | object): *[Dishwasher](_models_devicetypes_index_.dishwasher.md)*
...
**Returns:** *[Dishwasher](_models_devicetypes_index_.dishwasher.md)*
...
• **typeName**: *"action.devices.types.DISHWASHER"* = "action.devices.types.DISHWASHER"
...
*Defined in [src/models/devicetypes/index.ts:76](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L76)*
