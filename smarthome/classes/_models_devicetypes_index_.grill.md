[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Grill](_models_devicetypes_index_.grill.md)
...
* [constructor](_models_devicetypes_index_.grill.md#constructor)

### Properties

* [id](_models_devicetypes_index_.grill.md#id)
* [name](_models_devicetypes_index_.grill.md#name)
* [traits](_models_devicetypes_index_.grill.md#traits)
* [typeName](_models_devicetypes_index_.grill.md#typename)
* [willReportState](_models_devicetypes_index_.grill.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.grill.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.grill.md#createid)
* [getCommand](_models_devicetypes_index_.grill.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.grill.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.grill.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.grill.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.grill.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.grill.md#format)

## Constructors

###  constructor

\+ **new Grill**(`param?`: undefined | object): *[Grill](_models_devicetypes_index_.grill.md)*
...
**Returns:** *[Grill](_models_devicetypes_index_.grill.md)*
...
• **typeName**: *"action.devices.types.GRILL"* = "action.devices.types.GRILL"
...
*Defined in [src/models/devicetypes/index.ts:116](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L116)*
