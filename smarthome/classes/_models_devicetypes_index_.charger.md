[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Charger](_models_devicetypes_index_.charger.md)
...
* [constructor](_models_devicetypes_index_.charger.md#constructor)

### Properties

* [id](_models_devicetypes_index_.charger.md#id)
* [name](_models_devicetypes_index_.charger.md#name)
* [traits](_models_devicetypes_index_.charger.md#traits)
* [typeName](_models_devicetypes_index_.charger.md#typename)
* [willReportState](_models_devicetypes_index_.charger.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.charger.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.charger.md#createid)
* [getCommand](_models_devicetypes_index_.charger.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.charger.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.charger.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.charger.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.charger.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.charger.md#format)

## Constructors

###  constructor

\+ **new Charger**(`param?`: undefined | object): *[Charger](_models_devicetypes_index_.charger.md)*
...
**Returns:** *[Charger](_models_devicetypes_index_.charger.md)*
...
• **typeName**: *"action.devices.types.CHARGER"* = "action.devices.types.CHARGER"
...
*Defined in [src/models/devicetypes/index.ts:48](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L48)*
