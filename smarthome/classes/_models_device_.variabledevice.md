[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/device"](../modules/_models_device_.md) › [VariableDevice](_models_device_.variabledevice.md)
...
* [constructor](_models_device_.variabledevice.md#constructor)

### Properties

* [id](_models_device_.variabledevice.md#id)
* [name](_models_device_.variabledevice.md#name)
* [traits](_models_device_.variabledevice.md#traits)
* [typeName](_models_device_.variabledevice.md#typename)
* [willReportState](_models_device_.variabledevice.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_device_.variabledevice.md#[util.inspect.custom])
* [getCommand](_models_device_.variabledevice.md#getcommand)
* [getMergedAttributes](_models_device_.variabledevice.md#getmergedattributes)
* [getMergedStates](_models_device_.variabledevice.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_device_.variabledevice.md#gettraithavingspecificcommand)
* [getTraitNames](_models_device_.variabledevice.md#gettraitnames)

### Object literals

* [format](_models_device_.variabledevice.md#format)

## Constructors

###  constructor

\+ **new VariableDevice**(`param`: [DeviceJson](../interfaces/_models_interfaces_i_device_.devicejson.md)): *[VariableDevice](_models_device_.variabledevice.md)*

*Defined in [src/models/device.ts:238](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/device.ts#L238)*

**Parameters:**

Name | Type |
------ | ------ |
`param` | [DeviceJson](../interfaces/_models_interfaces_i_device_.devicejson.md) |

**Returns:** *[VariableDevice](_models_device_.variabledevice.md)*
