[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [AirFreshener](_models_devicetypes_index_.airfreshener.md)
...
* [constructor](_models_devicetypes_index_.airfreshener.md#constructor)

### Properties

* [id](_models_devicetypes_index_.airfreshener.md#id)
* [name](_models_devicetypes_index_.airfreshener.md#name)
* [traits](_models_devicetypes_index_.airfreshener.md#traits)
* [typeName](_models_devicetypes_index_.airfreshener.md#typename)
* [willReportState](_models_devicetypes_index_.airfreshener.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.airfreshener.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.airfreshener.md#createid)
* [getCommand](_models_devicetypes_index_.airfreshener.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.airfreshener.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.airfreshener.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.airfreshener.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.airfreshener.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.airfreshener.md#format)

## Constructors

###  constructor

\+ **new AirFreshener**(`param?`: undefined | object): *[AirFreshener](_models_devicetypes_index_.airfreshener.md)*
...
**Returns:** *[AirFreshener](_models_devicetypes_index_.airfreshener.md)*
...
• **typeName**: *"action.devices.types.AIRFRESHENER"* = "action.devices.types.AIRFRESHENER"
...
*Defined in [src/models/devicetypes/index.ts:8](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L8)*
