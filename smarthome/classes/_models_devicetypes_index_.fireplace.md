[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Fireplace](_models_devicetypes_index_.fireplace.md)
...
* [constructor](_models_devicetypes_index_.fireplace.md#constructor)

### Properties

* [id](_models_devicetypes_index_.fireplace.md#id)
* [name](_models_devicetypes_index_.fireplace.md#name)
* [traits](_models_devicetypes_index_.fireplace.md#traits)
* [typeName](_models_devicetypes_index_.fireplace.md#typename)
* [willReportState](_models_devicetypes_index_.fireplace.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.fireplace.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.fireplace.md#createid)
* [getCommand](_models_devicetypes_index_.fireplace.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.fireplace.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.fireplace.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.fireplace.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.fireplace.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.fireplace.md#format)

## Constructors

###  constructor

\+ **new Fireplace**(`param?`: undefined | object): *[Fireplace](_models_devicetypes_index_.fireplace.md)*
...
**Returns:** *[Fireplace](_models_devicetypes_index_.fireplace.md)*
...
• **typeName**: *"action.devices.types.FIREPLACE"* = "action.devices.types.FIREPLACE"
...
*Defined in [src/models/devicetypes/index.ts:100](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L100)*
