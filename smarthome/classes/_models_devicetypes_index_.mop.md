[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Mop](_models_devicetypes_index_.mop.md)
...
* [constructor](_models_devicetypes_index_.mop.md#constructor)

### Properties

* [id](_models_devicetypes_index_.mop.md#id)
* [name](_models_devicetypes_index_.mop.md#name)
* [traits](_models_devicetypes_index_.mop.md#traits)
* [typeName](_models_devicetypes_index_.mop.md#typename)
* [willReportState](_models_devicetypes_index_.mop.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.mop.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.mop.md#createid)
* [getCommand](_models_devicetypes_index_.mop.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.mop.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.mop.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.mop.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.mop.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.mop.md#format)

## Constructors

###  constructor

\+ **new Mop**(`param?`: undefined | object): *[Mop](_models_devicetypes_index_.mop.md)*
...
**Returns:** *[Mop](_models_devicetypes_index_.mop.md)*
...
• **typeName**: *"action.devices.types.MOP"* = "action.devices.types.MOP"
...
*Defined in [src/models/devicetypes/index.ts:148](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L148)*
