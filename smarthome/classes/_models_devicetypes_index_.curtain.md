[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Curtain](_models_devicetypes_index_.curtain.md)
...
* [constructor](_models_devicetypes_index_.curtain.md#constructor)

### Properties

* [id](_models_devicetypes_index_.curtain.md#id)
* [name](_models_devicetypes_index_.curtain.md#name)
* [traits](_models_devicetypes_index_.curtain.md#traits)
* [typeName](_models_devicetypes_index_.curtain.md#typename)
* [willReportState](_models_devicetypes_index_.curtain.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.curtain.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.curtain.md#createid)
* [getCommand](_models_devicetypes_index_.curtain.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.curtain.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.curtain.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.curtain.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.curtain.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.curtain.md#format)

## Constructors

###  constructor

\+ **new Curtain**(`param?`: undefined | object): *[Curtain](_models_devicetypes_index_.curtain.md)*
...
**Returns:** *[Curtain](_models_devicetypes_index_.curtain.md)*
...
• **typeName**: *"action.devices.types.CURTAIN"* = "action.devices.types.CURTAIN"
...
*Defined in [src/models/devicetypes/index.ts:64](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L64)*
