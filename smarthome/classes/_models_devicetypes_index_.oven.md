[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Oven](_models_devicetypes_index_.oven.md)
...
* [constructor](_models_devicetypes_index_.oven.md#constructor)

### Properties

* [id](_models_devicetypes_index_.oven.md#id)
* [name](_models_devicetypes_index_.oven.md#name)
* [traits](_models_devicetypes_index_.oven.md#traits)
* [typeName](_models_devicetypes_index_.oven.md#typename)
* [willReportState](_models_devicetypes_index_.oven.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.oven.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.oven.md#createid)
* [getCommand](_models_devicetypes_index_.oven.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.oven.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.oven.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.oven.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.oven.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.oven.md#format)

## Constructors

###  constructor

\+ **new Oven**(`param?`: undefined | object): *[Oven](_models_devicetypes_index_.oven.md)*
...
**Returns:** *[Oven](_models_devicetypes_index_.oven.md)*
...
• **typeName**: *"action.devices.types.OVEN"* = "action.devices.types.OVEN"
...
*Defined in [src/models/devicetypes/index.ts:172](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L172)*
