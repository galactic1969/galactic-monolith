[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Dryer](_models_devicetypes_index_.dryer.md)
...
* [constructor](_models_devicetypes_index_.dryer.md#constructor)

### Properties

* [id](_models_devicetypes_index_.dryer.md#id)
* [name](_models_devicetypes_index_.dryer.md#name)
* [traits](_models_devicetypes_index_.dryer.md#traits)
* [typeName](_models_devicetypes_index_.dryer.md#typename)
* [willReportState](_models_devicetypes_index_.dryer.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.dryer.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.dryer.md#createid)
* [getCommand](_models_devicetypes_index_.dryer.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.dryer.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.dryer.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.dryer.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.dryer.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.dryer.md#format)

## Constructors

###  constructor

\+ **new Dryer**(`param?`: undefined | object): *[Dryer](_models_devicetypes_index_.dryer.md)*
...
**Returns:** *[Dryer](_models_devicetypes_index_.dryer.md)*
...
• **typeName**: *"action.devices.types.DRYER"* = "action.devices.types.DRYER"
...
*Defined in [src/models/devicetypes/index.ts:88](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L88)*
