[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Securitysystem](_models_devicetypes_index_.securitysystem.md)
...
* [constructor](_models_devicetypes_index_.securitysystem.md#constructor)

### Properties

* [id](_models_devicetypes_index_.securitysystem.md#id)
* [name](_models_devicetypes_index_.securitysystem.md#name)
* [traits](_models_devicetypes_index_.securitysystem.md#traits)
* [typeName](_models_devicetypes_index_.securitysystem.md#typename)
* [willReportState](_models_devicetypes_index_.securitysystem.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.securitysystem.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.securitysystem.md#createid)
* [getCommand](_models_devicetypes_index_.securitysystem.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.securitysystem.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.securitysystem.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.securitysystem.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.securitysystem.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.securitysystem.md#format)

## Constructors

###  constructor

\+ **new Securitysystem**(`param?`: undefined | object): *[Securitysystem](_models_devicetypes_index_.securitysystem.md)*
...
**Returns:** *[Securitysystem](_models_devicetypes_index_.securitysystem.md)*
...
• **typeName**: *"action.devices.types.SECURITYSYSTEM"* = "action.devices.types.SECURITYSYSTEM"
...
*Defined in [src/models/devicetypes/index.ts:208](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L208)*
