[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Gate](_models_devicetypes_index_.gate.md)
...
* [constructor](_models_devicetypes_index_.gate.md#constructor)

### Properties

* [id](_models_devicetypes_index_.gate.md#id)
* [name](_models_devicetypes_index_.gate.md#name)
* [traits](_models_devicetypes_index_.gate.md#traits)
* [typeName](_models_devicetypes_index_.gate.md#typename)
* [willReportState](_models_devicetypes_index_.gate.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.gate.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.gate.md#createid)
* [getCommand](_models_devicetypes_index_.gate.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.gate.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.gate.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.gate.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.gate.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.gate.md#format)

## Constructors

###  constructor

\+ **new Gate**(`param?`: undefined | object): *[Gate](_models_devicetypes_index_.gate.md)*
...
**Returns:** *[Gate](_models_devicetypes_index_.gate.md)*
...
• **typeName**: *"action.devices.types.GATE"* = "action.devices.types.GATE"
...
*Defined in [src/models/devicetypes/index.ts:112](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L112)*
