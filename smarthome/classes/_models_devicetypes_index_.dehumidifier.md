[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Dehumidifier](_models_devicetypes_index_.dehumidifier.md)
...
* [constructor](_models_devicetypes_index_.dehumidifier.md#constructor)

### Properties

* [id](_models_devicetypes_index_.dehumidifier.md#id)
* [name](_models_devicetypes_index_.dehumidifier.md#name)
* [traits](_models_devicetypes_index_.dehumidifier.md#traits)
* [typeName](_models_devicetypes_index_.dehumidifier.md#typename)
* [willReportState](_models_devicetypes_index_.dehumidifier.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.dehumidifier.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.dehumidifier.md#createid)
* [getCommand](_models_devicetypes_index_.dehumidifier.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.dehumidifier.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.dehumidifier.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.dehumidifier.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.dehumidifier.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.dehumidifier.md#format)

## Constructors

###  constructor

\+ **new Dehumidifier**(`param?`: undefined | object): *[Dehumidifier](_models_devicetypes_index_.dehumidifier.md)*
...
**Returns:** *[Dehumidifier](_models_devicetypes_index_.dehumidifier.md)*
...
• **typeName**: *"action.devices.types.DEHUMIDIFIER"* = "action.devices.types.DEHUMIDIFIER"
...
*Defined in [src/models/devicetypes/index.ts:68](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L68)*
