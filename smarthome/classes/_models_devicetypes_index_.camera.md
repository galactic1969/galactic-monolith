[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Camera](_models_devicetypes_index_.camera.md)
...
* [constructor](_models_devicetypes_index_.camera.md#constructor)

### Properties

* [id](_models_devicetypes_index_.camera.md#id)
* [name](_models_devicetypes_index_.camera.md#name)
* [traits](_models_devicetypes_index_.camera.md#traits)
* [typeName](_models_devicetypes_index_.camera.md#typename)
* [willReportState](_models_devicetypes_index_.camera.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.camera.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.camera.md#createid)
* [getCommand](_models_devicetypes_index_.camera.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.camera.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.camera.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.camera.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.camera.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.camera.md#format)

## Constructors

###  constructor

\+ **new Camera**(`param?`: undefined | object): *[Camera](_models_devicetypes_index_.camera.md)*
...
**Returns:** *[Camera](_models_devicetypes_index_.camera.md)*
...
• **typeName**: *"action.devices.types.CAMERA"* = "action.devices.types.CAMERA"
...
*Defined in [src/models/devicetypes/index.ts:40](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L40)*
