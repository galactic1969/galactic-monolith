[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [AirPurifier](_models_devicetypes_index_.airpurifier.md)
...
* [constructor](_models_devicetypes_index_.airpurifier.md#constructor)

### Properties

* [id](_models_devicetypes_index_.airpurifier.md#id)
* [name](_models_devicetypes_index_.airpurifier.md#name)
* [traits](_models_devicetypes_index_.airpurifier.md#traits)
* [typeName](_models_devicetypes_index_.airpurifier.md#typename)
* [willReportState](_models_devicetypes_index_.airpurifier.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.airpurifier.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.airpurifier.md#createid)
* [getCommand](_models_devicetypes_index_.airpurifier.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.airpurifier.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.airpurifier.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.airpurifier.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.airpurifier.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.airpurifier.md#format)

## Constructors

###  constructor

\+ **new AirPurifier**(`param?`: undefined | object): *[AirPurifier](_models_devicetypes_index_.airpurifier.md)*
...
**Returns:** *[AirPurifier](_models_devicetypes_index_.airpurifier.md)*
...
• **typeName**: *"action.devices.types.AIRPURIFIER"* = "action.devices.types.AIRPURIFIER"
...
*Defined in [src/models/devicetypes/index.ts:12](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L12)*
