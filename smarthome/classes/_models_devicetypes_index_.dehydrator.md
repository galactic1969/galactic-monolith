[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Dehydrator](_models_devicetypes_index_.dehydrator.md)
...
* [constructor](_models_devicetypes_index_.dehydrator.md#constructor)

### Properties

* [id](_models_devicetypes_index_.dehydrator.md#id)
* [name](_models_devicetypes_index_.dehydrator.md#name)
* [traits](_models_devicetypes_index_.dehydrator.md#traits)
* [typeName](_models_devicetypes_index_.dehydrator.md#typename)
* [willReportState](_models_devicetypes_index_.dehydrator.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.dehydrator.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.dehydrator.md#createid)
* [getCommand](_models_devicetypes_index_.dehydrator.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.dehydrator.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.dehydrator.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.dehydrator.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.dehydrator.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.dehydrator.md#format)

## Constructors

###  constructor

\+ **new Dehydrator**(`param?`: undefined | object): *[Dehydrator](_models_devicetypes_index_.dehydrator.md)*
...
**Returns:** *[Dehydrator](_models_devicetypes_index_.dehydrator.md)*
...
• **typeName**: *"action.devices.types.DEHYDRATOR"* = "action.devices.types.DEHYDRATOR"
...
*Defined in [src/models/devicetypes/index.ts:72](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L72)*
