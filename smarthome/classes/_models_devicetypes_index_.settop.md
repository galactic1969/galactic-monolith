[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Settop](_models_devicetypes_index_.settop.md)
...
* [constructor](_models_devicetypes_index_.settop.md#constructor)

### Properties

* [id](_models_devicetypes_index_.settop.md#id)
* [name](_models_devicetypes_index_.settop.md#name)
* [traits](_models_devicetypes_index_.settop.md#traits)
* [typeName](_models_devicetypes_index_.settop.md#typename)
* [willReportState](_models_devicetypes_index_.settop.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.settop.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.settop.md#createid)
* [getCommand](_models_devicetypes_index_.settop.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.settop.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.settop.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.settop.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.settop.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.settop.md#format)

## Constructors

###  constructor

\+ **new Settop**(`param?`: undefined | object): *[Settop](_models_devicetypes_index_.settop.md)*
...
**Returns:** *[Settop](_models_devicetypes_index_.settop.md)*
...
• **typeName**: *"action.devices.types.SETTOP"* = "action.devices.types.SETTOP"
...
*Defined in [src/models/devicetypes/index.ts:212](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L212)*
