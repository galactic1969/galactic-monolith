[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/traits/volume/volume"](../modules/_models_traits_volume_volume_.md) › [Volume](_models_traits_volume_volume_.volume.md)
...
* [VolumeTrait](../interfaces/_models_traits_i_traits_.volumetrait.md)

## Index

### Constructors

* [constructor](_models_traits_volume_volume_.volume.md#constructor)

### Properties

* [Attributes](_models_traits_volume_volume_.volume.md#attributes)
* [Commands](_models_traits_volume_volume_.volume.md#commands)
* [States](_models_traits_volume_volume_.volume.md#states)
* [name](_models_traits_volume_volume_.volume.md#name)

### Methods

* [getAttribute](_models_traits_volume_volume_.volume.md#getattribute)
* [getCommand](_models_traits_volume_volume_.volume.md#getcommand)
* [getElement](_models_traits_volume_volume_.volume.md#getelement)
* [getElements](_models_traits_volume_volume_.volume.md#getelements)
* [getKeyName](_models_traits_volume_volume_.volume.md#getkeyname)
* [getMergedAttributes](_models_traits_volume_volume_.volume.md#getmergedattributes)
* [getMergedStates](_models_traits_volume_volume_.volume.md#getmergedstates)
* [getState](_models_traits_volume_volume_.volume.md#getstate)
* [hasAttribute](_models_traits_volume_volume_.volume.md#hasattribute)
* [hasAttributes](_models_traits_volume_volume_.volume.md#hasattributes)
* [hasCommand](_models_traits_volume_volume_.volume.md#hascommand)
* [hasCommands](_models_traits_volume_volume_.volume.md#hascommands)
* [hasElement](_models_traits_volume_volume_.volume.md#haselement)
* [hasState](_models_traits_volume_volume_.volume.md#hasstate)
* [hasStates](_models_traits_volume_volume_.volume.md#hasstates)
* [shouldHaveAttributes](_models_traits_volume_volume_.volume.md#shouldhaveattributes)
* [shouldHaveCommands](_models_traits_volume_volume_.volume.md#shouldhavecommands)
* [shouldHaveElements](_models_traits_volume_volume_.volume.md#shouldhaveelements)
* [shouldHaveStates](_models_traits_volume_volume_.volume.md#shouldhavestates)
* [toJsonObject](_models_traits_volume_volume_.volume.md#tojsonobject)
* [validate](_models_traits_volume_volume_.volume.md#validate)
* [getKeyName](_models_traits_volume_volume_.volume.md#static-getkeyname)
* [getName](_models_traits_volume_volume_.volume.md#static-getname)
* [init](_models_traits_volume_volume_.volume.md#static-init)
* [initWithJson](_models_traits_volume_volume_.volume.md#static-initwithjson)
* [resolveAttributes](_models_traits_volume_volume_.volume.md#static-resolveattributes)
* [resolveCommands](_models_traits_volume_volume_.volume.md#static-resolvecommands)
* [resolveStates](_models_traits_volume_volume_.volume.md#static-resolvestates)

## Constructors

###  constructor

\+ **new Volume**(`param`: [VolumeParam](../interfaces/_models_traits_i_traits_.volumeparam.md)): *[Volume](_models_traits_volume_volume_.volume.md)*

*Overrides [Trait](_models_core_.trait.md).[constructor](_models_core_.trait.md#constructor)*

*Defined in [src/models/traits/volume/volume.ts:10](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/volume/volume.ts#L10)*

**Parameters:**

Name | Type |
------ | ------ |
`param` | [VolumeParam](../interfaces/_models_traits_i_traits_.volumeparam.md) |

**Returns:** *[Volume](_models_traits_volume_volume_.volume.md)*
...
*Implementation of [VolumeTrait](../interfaces/_models_traits_i_traits_.volumetrait.md).[Attributes](../interfaces/_models_traits_i_traits_.volumetrait.md#attributes)*
...
*Implementation of [VolumeTrait](../interfaces/_models_traits_i_traits_.volumetrait.md).[Commands](../interfaces/_models_traits_i_traits_.volumetrait.md#commands)*
...
*Implementation of [VolumeTrait](../interfaces/_models_traits_i_traits_.volumetrait.md).[States](../interfaces/_models_traits_i_traits_.volumetrait.md#states)*
...
• **name**: *"action.devices.traits.Volume"* = "action.devices.traits.Volume"

*Implementation of [VolumeTrait](../interfaces/_models_traits_i_traits_.volumetrait.md).[name](../interfaces/_models_traits_i_traits_.volumetrait.md#name)*
...
*Defined in [src/models/traits/volume/volume.ts:19](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/volume/volume.ts#L19)*
...
▸ **init**(`param`: [VariableTrait](../interfaces/_models_interfaces_i_core_.variabletrait.md)): *[Volume](_models_traits_volume_volume_.volume.md)*

*Overrides [Trait](_models_core_.trait.md).[init](_models_core_.trait.md#static-init)*

*Defined in [src/models/traits/volume/volume.ts:15](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/volume/volume.ts#L15)*
