[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Remotecontrol](_models_devicetypes_index_.remotecontrol.md)
...
* [constructor](_models_devicetypes_index_.remotecontrol.md#constructor)

### Properties

* [id](_models_devicetypes_index_.remotecontrol.md#id)
* [name](_models_devicetypes_index_.remotecontrol.md#name)
* [traits](_models_devicetypes_index_.remotecontrol.md#traits)
* [typeName](_models_devicetypes_index_.remotecontrol.md#typename)
* [willReportState](_models_devicetypes_index_.remotecontrol.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.remotecontrol.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.remotecontrol.md#createid)
* [getCommand](_models_devicetypes_index_.remotecontrol.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.remotecontrol.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.remotecontrol.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.remotecontrol.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.remotecontrol.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.remotecontrol.md#format)

## Constructors

###  constructor

\+ **new Remotecontrol**(`param?`: undefined | object): *[Remotecontrol](_models_devicetypes_index_.remotecontrol.md)*
...
**Returns:** *[Remotecontrol](_models_devicetypes_index_.remotecontrol.md)*
...
• **typeName**: *"action.devices.types.REMOTECONTROL"* = "action.devices.types.REMOTECONTROL"
...
*Defined in [src/models/devicetypes/index.ts:144](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L144)*
