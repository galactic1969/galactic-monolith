[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Microwave](_models_devicetypes_index_.microwave.md)
...
* [constructor](_models_devicetypes_index_.microwave.md#constructor)

### Properties

* [id](_models_devicetypes_index_.microwave.md#id)
* [name](_models_devicetypes_index_.microwave.md#name)
* [traits](_models_devicetypes_index_.microwave.md#traits)
* [typeName](_models_devicetypes_index_.microwave.md#typename)
* [willReportState](_models_devicetypes_index_.microwave.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.microwave.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.microwave.md#createid)
* [getCommand](_models_devicetypes_index_.microwave.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.microwave.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.microwave.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.microwave.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.microwave.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.microwave.md#format)

## Constructors

###  constructor

\+ **new Microwave**(`param?`: undefined | object): *[Microwave](_models_devicetypes_index_.microwave.md)*
...
**Returns:** *[Microwave](_models_devicetypes_index_.microwave.md)*
...
• **typeName**: *"action.devices.types.MICROWAVE"* = "action.devices.types.MICROWAVE"
...
*Defined in [src/models/devicetypes/index.ts:156](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L156)*
