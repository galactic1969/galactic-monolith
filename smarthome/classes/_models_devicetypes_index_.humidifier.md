[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Humidifier](_models_devicetypes_index_.humidifier.md)
...
* [constructor](_models_devicetypes_index_.humidifier.md#constructor)

### Properties

* [id](_models_devicetypes_index_.humidifier.md#id)
* [name](_models_devicetypes_index_.humidifier.md#name)
* [traits](_models_devicetypes_index_.humidifier.md#traits)
* [typeName](_models_devicetypes_index_.humidifier.md#typename)
* [willReportState](_models_devicetypes_index_.humidifier.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.humidifier.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.humidifier.md#createid)
* [getCommand](_models_devicetypes_index_.humidifier.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.humidifier.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.humidifier.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.humidifier.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.humidifier.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.humidifier.md#format)

## Constructors

###  constructor

\+ **new Humidifier**(`param?`: undefined | object): *[Humidifier](_models_devicetypes_index_.humidifier.md)*
...
**Returns:** *[Humidifier](_models_devicetypes_index_.humidifier.md)*
...
• **typeName**: *"action.devices.types.HUMIDIFIER"* = "action.devices.types.HUMIDIFIER"
...
*Defined in [src/models/devicetypes/index.ts:128](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L128)*
