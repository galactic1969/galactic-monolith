[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Light](_models_devicetypes_index_.light.md)
...
* [constructor](_models_devicetypes_index_.light.md#constructor)

### Properties

* [id](_models_devicetypes_index_.light.md#id)
* [name](_models_devicetypes_index_.light.md#name)
* [traits](_models_devicetypes_index_.light.md#traits)
* [typeName](_models_devicetypes_index_.light.md#typename)
* [willReportState](_models_devicetypes_index_.light.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.light.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.light.md#createid)
* [getCommand](_models_devicetypes_index_.light.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.light.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.light.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.light.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.light.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.light.md#format)

## Constructors

###  constructor

\+ **new Light**(`param?`: undefined | object): *[Light](_models_devicetypes_index_.light.md)*
...
**Returns:** *[Light](_models_devicetypes_index_.light.md)*
...
• **typeName**: *"action.devices.types.LIGHT"* = "action.devices.types.LIGHT"
...
*Defined in [src/models/devicetypes/index.ts:136](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L136)*
