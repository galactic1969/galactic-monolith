[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Blender](_models_devicetypes_index_.blender.md)
...
* [constructor](_models_devicetypes_index_.blender.md#constructor)

### Properties

* [id](_models_devicetypes_index_.blender.md#id)
* [name](_models_devicetypes_index_.blender.md#name)
* [traits](_models_devicetypes_index_.blender.md#traits)
* [typeName](_models_devicetypes_index_.blender.md#typename)
* [willReportState](_models_devicetypes_index_.blender.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.blender.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.blender.md#createid)
* [getCommand](_models_devicetypes_index_.blender.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.blender.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.blender.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.blender.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.blender.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.blender.md#format)

## Constructors

###  constructor

\+ **new Blender**(`param?`: undefined | object): *[Blender](_models_devicetypes_index_.blender.md)*
...
**Returns:** *[Blender](_models_devicetypes_index_.blender.md)*
...
• **typeName**: *"action.devices.types.BLENDER"* = "action.devices.types.BLENDER"
...
*Defined in [src/models/devicetypes/index.ts:28](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L28)*
