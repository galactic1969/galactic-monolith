[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [CarbonMonoxideDetector](_models_devicetypes_index_.carbonmonoxidedetector.md)
...
* [constructor](_models_devicetypes_index_.carbonmonoxidedetector.md#constructor)

### Properties

* [id](_models_devicetypes_index_.carbonmonoxidedetector.md#id)
* [name](_models_devicetypes_index_.carbonmonoxidedetector.md#name)
* [traits](_models_devicetypes_index_.carbonmonoxidedetector.md#traits)
* [typeName](_models_devicetypes_index_.carbonmonoxidedetector.md#typename)
* [willReportState](_models_devicetypes_index_.carbonmonoxidedetector.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.carbonmonoxidedetector.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.carbonmonoxidedetector.md#createid)
* [getCommand](_models_devicetypes_index_.carbonmonoxidedetector.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.carbonmonoxidedetector.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.carbonmonoxidedetector.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.carbonmonoxidedetector.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.carbonmonoxidedetector.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.carbonmonoxidedetector.md#format)

## Constructors

###  constructor

\+ **new CarbonMonoxideDetector**(`param?`: undefined | object): *[CarbonMonoxideDetector](_models_devicetypes_index_.carbonmonoxidedetector.md)*
...
**Returns:** *[CarbonMonoxideDetector](_models_devicetypes_index_.carbonmonoxidedetector.md)*
...
• **typeName**: *"action.devices.types.CARBON_MONOXIDE_DETECTOR"* = "action.devices.types.CARBON_MONOXIDE_DETECTOR"
...
*Defined in [src/models/devicetypes/index.ts:44](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L44)*
