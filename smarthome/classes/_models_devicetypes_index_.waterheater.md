[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Waterheater](_models_devicetypes_index_.waterheater.md)
...
* [constructor](_models_devicetypes_index_.waterheater.md#constructor)

### Properties

* [id](_models_devicetypes_index_.waterheater.md#id)
* [name](_models_devicetypes_index_.waterheater.md#name)
* [traits](_models_devicetypes_index_.waterheater.md#traits)
* [typeName](_models_devicetypes_index_.waterheater.md#typename)
* [willReportState](_models_devicetypes_index_.waterheater.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.waterheater.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.waterheater.md#createid)
* [getCommand](_models_devicetypes_index_.waterheater.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.waterheater.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.waterheater.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.waterheater.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.waterheater.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.waterheater.md#format)

## Constructors

###  constructor

\+ **new Waterheater**(`param?`: undefined | object): *[Waterheater](_models_devicetypes_index_.waterheater.md)*
...
**Returns:** *[Waterheater](_models_devicetypes_index_.waterheater.md)*
...
• **typeName**: *"action.devices.types.WATERHEATER"* = "action.devices.types.WATERHEATER"
...
*Defined in [src/models/devicetypes/index.ts:260](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L260)*
