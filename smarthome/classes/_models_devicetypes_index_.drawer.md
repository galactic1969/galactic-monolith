[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Drawer](_models_devicetypes_index_.drawer.md)
...
* [constructor](_models_devicetypes_index_.drawer.md#constructor)

### Properties

* [id](_models_devicetypes_index_.drawer.md#id)
* [name](_models_devicetypes_index_.drawer.md#name)
* [traits](_models_devicetypes_index_.drawer.md#traits)
* [typeName](_models_devicetypes_index_.drawer.md#typename)
* [willReportState](_models_devicetypes_index_.drawer.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.drawer.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.drawer.md#createid)
* [getCommand](_models_devicetypes_index_.drawer.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.drawer.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.drawer.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.drawer.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.drawer.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.drawer.md#format)

## Constructors

###  constructor

\+ **new Drawer**(`param?`: undefined | object): *[Drawer](_models_devicetypes_index_.drawer.md)*
...
**Returns:** *[Drawer](_models_devicetypes_index_.drawer.md)*
...
• **typeName**: *"action.devices.types.DRAWER"* = "action.devices.types.DRAWER"
...
*Defined in [src/models/devicetypes/index.ts:84](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L84)*
