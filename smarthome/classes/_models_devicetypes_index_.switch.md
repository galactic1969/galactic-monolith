[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Switch](_models_devicetypes_index_.switch.md)
...
* [constructor](_models_devicetypes_index_.switch.md#constructor)

### Properties

* [id](_models_devicetypes_index_.switch.md#id)
* [name](_models_devicetypes_index_.switch.md#name)
* [traits](_models_devicetypes_index_.switch.md#traits)
* [typeName](_models_devicetypes_index_.switch.md#typename)
* [willReportState](_models_devicetypes_index_.switch.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.switch.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.switch.md#createid)
* [getCommand](_models_devicetypes_index_.switch.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.switch.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.switch.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.switch.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.switch.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.switch.md#format)

## Constructors

###  constructor

\+ **new Switch**(`param?`: undefined | object): *[Switch](_models_devicetypes_index_.switch.md)*
...
**Returns:** *[Switch](_models_devicetypes_index_.switch.md)*
...
• **typeName**: *"action.devices.types.SWITCH"* = "action.devices.types.SWITCH"
...
*Defined in [src/models/devicetypes/index.ts:236](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L236)*
