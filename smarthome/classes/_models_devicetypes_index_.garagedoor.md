[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [GarageDoor](_models_devicetypes_index_.garagedoor.md)
...
* [constructor](_models_devicetypes_index_.garagedoor.md#constructor)

### Properties

* [id](_models_devicetypes_index_.garagedoor.md#id)
* [name](_models_devicetypes_index_.garagedoor.md#name)
* [traits](_models_devicetypes_index_.garagedoor.md#traits)
* [typeName](_models_devicetypes_index_.garagedoor.md#typename)
* [willReportState](_models_devicetypes_index_.garagedoor.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.garagedoor.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.garagedoor.md#createid)
* [getCommand](_models_devicetypes_index_.garagedoor.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.garagedoor.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.garagedoor.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.garagedoor.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.garagedoor.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.garagedoor.md#format)

## Constructors

###  constructor

\+ **new GarageDoor**(`param?`: undefined | object): *[GarageDoor](_models_devicetypes_index_.garagedoor.md)*
...
**Returns:** *[GarageDoor](_models_devicetypes_index_.garagedoor.md)*
...
• **typeName**: *"action.devices.types.GARAGE"* = "action.devices.types.GARAGE"
...
*Defined in [src/models/devicetypes/index.ts:108](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L108)*
