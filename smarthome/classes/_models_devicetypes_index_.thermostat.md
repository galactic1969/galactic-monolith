[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Thermostat](_models_devicetypes_index_.thermostat.md)
...
* [constructor](_models_devicetypes_index_.thermostat.md#constructor)

### Properties

* [id](_models_devicetypes_index_.thermostat.md#id)
* [name](_models_devicetypes_index_.thermostat.md#name)
* [traits](_models_devicetypes_index_.thermostat.md#traits)
* [typeName](_models_devicetypes_index_.thermostat.md#typename)
* [willReportState](_models_devicetypes_index_.thermostat.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.thermostat.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.thermostat.md#createid)
* [getCommand](_models_devicetypes_index_.thermostat.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.thermostat.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.thermostat.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.thermostat.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.thermostat.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.thermostat.md#format)

## Constructors

###  constructor

\+ **new Thermostat**(`param?`: undefined | object): *[Thermostat](_models_devicetypes_index_.thermostat.md)*
...
**Returns:** *[Thermostat](_models_devicetypes_index_.thermostat.md)*
...
• **typeName**: *"action.devices.types.THERMOSTAT"* = "action.devices.types.THERMOSTAT"
...
*Defined in [src/models/devicetypes/index.ts:244](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L244)*
