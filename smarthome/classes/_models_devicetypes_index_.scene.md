[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Scene](_models_devicetypes_index_.scene.md)
...
* [constructor](_models_devicetypes_index_.scene.md#constructor)

### Properties

* [id](_models_devicetypes_index_.scene.md#id)
* [name](_models_devicetypes_index_.scene.md#name)
* [traits](_models_devicetypes_index_.scene.md#traits)
* [typeName](_models_devicetypes_index_.scene.md#typename)
* [willReportState](_models_devicetypes_index_.scene.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.scene.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.scene.md#createid)
* [getCommand](_models_devicetypes_index_.scene.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.scene.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.scene.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.scene.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.scene.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.scene.md#format)

## Constructors

###  constructor

\+ **new Scene**(`param?`: undefined | object): *[Scene](_models_devicetypes_index_.scene.md)*
...
**Returns:** *[Scene](_models_devicetypes_index_.scene.md)*
...
• **typeName**: *"action.devices.types.SCENE"* = "action.devices.types.SCENE"
...
*Defined in [src/models/devicetypes/index.ts:200](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L200)*
