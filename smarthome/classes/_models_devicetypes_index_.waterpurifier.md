[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Waterpurifier](_models_devicetypes_index_.waterpurifier.md)
...
* [constructor](_models_devicetypes_index_.waterpurifier.md#constructor)

### Properties

* [id](_models_devicetypes_index_.waterpurifier.md#id)
* [name](_models_devicetypes_index_.waterpurifier.md#name)
* [traits](_models_devicetypes_index_.waterpurifier.md#traits)
* [typeName](_models_devicetypes_index_.waterpurifier.md#typename)
* [willReportState](_models_devicetypes_index_.waterpurifier.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.waterpurifier.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.waterpurifier.md#createid)
* [getCommand](_models_devicetypes_index_.waterpurifier.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.waterpurifier.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.waterpurifier.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.waterpurifier.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.waterpurifier.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.waterpurifier.md#format)

## Constructors

###  constructor

\+ **new Waterpurifier**(`param?`: undefined | object): *[Waterpurifier](_models_devicetypes_index_.waterpurifier.md)*
...
**Returns:** *[Waterpurifier](_models_devicetypes_index_.waterpurifier.md)*
...
• **typeName**: *"action.devices.types.WATERPURIFIER"* = "action.devices.types.WATERPURIFIER"
...
*Defined in [src/models/devicetypes/index.ts:264](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L264)*
