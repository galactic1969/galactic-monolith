[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Boiler](_models_devicetypes_index_.boiler.md)
...
* [constructor](_models_devicetypes_index_.boiler.md#constructor)

### Properties

* [id](_models_devicetypes_index_.boiler.md#id)
* [name](_models_devicetypes_index_.boiler.md#name)
* [traits](_models_devicetypes_index_.boiler.md#traits)
* [typeName](_models_devicetypes_index_.boiler.md#typename)
* [willReportState](_models_devicetypes_index_.boiler.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.boiler.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.boiler.md#createid)
* [getCommand](_models_devicetypes_index_.boiler.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.boiler.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.boiler.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.boiler.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.boiler.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.boiler.md#format)

## Constructors

###  constructor

\+ **new Boiler**(`param?`: undefined | object): *[Boiler](_models_devicetypes_index_.boiler.md)*
...
**Returns:** *[Boiler](_models_devicetypes_index_.boiler.md)*
...
• **typeName**: *"action.devices.types.BOILER"* = "action.devices.types.BOILER"
...
*Defined in [src/models/devicetypes/index.ts:36](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L36)*
