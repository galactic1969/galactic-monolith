[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Kettle](_models_devicetypes_index_.kettle.md)
...
* [constructor](_models_devicetypes_index_.kettle.md#constructor)

### Properties

* [id](_models_devicetypes_index_.kettle.md#id)
* [name](_models_devicetypes_index_.kettle.md#name)
* [traits](_models_devicetypes_index_.kettle.md#traits)
* [typeName](_models_devicetypes_index_.kettle.md#typename)
* [willReportState](_models_devicetypes_index_.kettle.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.kettle.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.kettle.md#createid)
* [getCommand](_models_devicetypes_index_.kettle.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.kettle.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.kettle.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.kettle.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.kettle.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.kettle.md#format)

## Constructors

###  constructor

\+ **new Kettle**(`param?`: undefined | object): *[Kettle](_models_devicetypes_index_.kettle.md)*
...
**Returns:** *[Kettle](_models_devicetypes_index_.kettle.md)*
...
• **typeName**: *"action.devices.types.KETTLE"* = "action.devices.types.KETTLE"
...
*Defined in [src/models/devicetypes/index.ts:132](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L132)*
