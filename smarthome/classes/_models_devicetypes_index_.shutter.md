[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Shutter](_models_devicetypes_index_.shutter.md)
...
* [constructor](_models_devicetypes_index_.shutter.md#constructor)

### Properties

* [id](_models_devicetypes_index_.shutter.md#id)
* [name](_models_devicetypes_index_.shutter.md#name)
* [traits](_models_devicetypes_index_.shutter.md#traits)
* [typeName](_models_devicetypes_index_.shutter.md#typename)
* [willReportState](_models_devicetypes_index_.shutter.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.shutter.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.shutter.md#createid)
* [getCommand](_models_devicetypes_index_.shutter.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.shutter.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.shutter.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.shutter.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.shutter.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.shutter.md#format)

## Constructors

###  constructor

\+ **new Shutter**(`param?`: undefined | object): *[Shutter](_models_devicetypes_index_.shutter.md)*
...
**Returns:** *[Shutter](_models_devicetypes_index_.shutter.md)*
...
• **typeName**: *"action.devices.types.SHUTTER"* = "action.devices.types.SHUTTER"
...
*Defined in [src/models/devicetypes/index.ts:216](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L216)*
