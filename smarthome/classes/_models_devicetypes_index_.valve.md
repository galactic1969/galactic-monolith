[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Valve](_models_devicetypes_index_.valve.md)
...
* [constructor](_models_devicetypes_index_.valve.md#constructor)

### Properties

* [id](_models_devicetypes_index_.valve.md#id)
* [name](_models_devicetypes_index_.valve.md#name)
* [traits](_models_devicetypes_index_.valve.md#traits)
* [typeName](_models_devicetypes_index_.valve.md#typename)
* [willReportState](_models_devicetypes_index_.valve.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.valve.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.valve.md#createid)
* [getCommand](_models_devicetypes_index_.valve.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.valve.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.valve.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.valve.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.valve.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.valve.md#format)

## Constructors

###  constructor

\+ **new Valve**(`param?`: undefined | object): *[Valve](_models_devicetypes_index_.valve.md)*
...
**Returns:** *[Valve](_models_devicetypes_index_.valve.md)*
...
• **typeName**: *"action.devices.types.VALVE"* = "action.devices.types.VALVE"
...
*Defined in [src/models/devicetypes/index.ts:252](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L252)*
