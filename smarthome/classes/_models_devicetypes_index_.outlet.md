[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Outlet](_models_devicetypes_index_.outlet.md)
...
* [constructor](_models_devicetypes_index_.outlet.md#constructor)

### Properties

* [id](_models_devicetypes_index_.outlet.md#id)
* [name](_models_devicetypes_index_.outlet.md#name)
* [traits](_models_devicetypes_index_.outlet.md#traits)
* [typeName](_models_devicetypes_index_.outlet.md#typename)
* [willReportState](_models_devicetypes_index_.outlet.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.outlet.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.outlet.md#createid)
* [getCommand](_models_devicetypes_index_.outlet.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.outlet.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.outlet.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.outlet.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.outlet.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.outlet.md#format)

## Constructors

###  constructor

\+ **new Outlet**(`param?`: undefined | object): *[Outlet](_models_devicetypes_index_.outlet.md)*
...
**Returns:** *[Outlet](_models_devicetypes_index_.outlet.md)*
...
• **typeName**: *"action.devices.types.OUTLET"* = "action.devices.types.OUTLET"
...
*Defined in [src/models/devicetypes/index.ts:168](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L168)*
