[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/traits/openclose/openclose_commands"](../modules/_models_traits_openclose_openclose_commands_.md) › [OpenClose](_models_traits_openclose_openclose_commands_.openclose.md)
...
* [constructor](_models_traits_openclose_openclose_commands_.openclose.md#constructor)

### Properties

* [name](_models_traits_openclose_openclose_commands_.openclose.md#name)
* [param](_models_traits_openclose_openclose_commands_.openclose.md#param)
* [_name](_models_traits_openclose_openclose_commands_.openclose.md#static-_name)

### Methods

* [askAcknowledgment](_models_traits_openclose_openclose_commands_.openclose.md#askacknowledgment)
* [askPinCode](_models_traits_openclose_openclose_commands_.openclose.md#askpincode)
* [checkAcknowledgement](_models_traits_openclose_openclose_commands_.openclose.md#checkacknowledgement)
* [checkChallenge](_models_traits_openclose_openclose_commands_.openclose.md#checkchallenge)
* [checkPinCode](_models_traits_openclose_openclose_commands_.openclose.md#checkpincode)
* [execute](_models_traits_openclose_openclose_commands_.openclose.md#execute)
* [getChallengeType](_models_traits_openclose_openclose_commands_.openclose.md#getchallengetype)
* [getKeyName](_models_traits_openclose_openclose_commands_.openclose.md#getkeyname)
* [getMaksedParam](_models_traits_openclose_openclose_commands_.openclose.md#getmaksedparam)
* [getMergedStates](_models_traits_openclose_openclose_commands_.openclose.md#getmergedstates)
* [getName](_models_traits_openclose_openclose_commands_.openclose.md#getname)
* [getState](_models_traits_openclose_openclose_commands_.openclose.md#getstate)
* [hasChallengeType](_models_traits_openclose_openclose_commands_.openclose.md#haschallengetype)
* [reportInvalidPinCode](_models_traits_openclose_openclose_commands_.openclose.md#reportinvalidpincode)
* [setState](_models_traits_openclose_openclose_commands_.openclose.md#setstate)
* [getKeyName](_models_traits_openclose_openclose_commands_.openclose.md#static-getkeyname)
* [getName](_models_traits_openclose_openclose_commands_.openclose.md#static-getname)

## Constructors

###  constructor

\+ **new OpenClose**(`init`: Command["param"]): *[OpenClose](_models_traits_openclose_openclose_commands_.openclose.md)*
...
**Returns:** *[OpenClose](_models_traits_openclose_openclose_commands_.openclose.md)*

## Properties

###  name

• **name**: *"action.devices.commands.OpenClose"* = OpenClose._name
...
*Defined in [src/models/traits/openclose/openclose_commands.ts:10](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/openclose/openclose_commands.ts#L10)*
...
▪ **_name**: *"action.devices.commands.OpenClose"* = "action.devices.commands.OpenClose"

*Overrides [Command](_models_core_.command.md).[_name](_models_core_.command.md#static-_name)*

*Defined in [src/models/traits/openclose/openclose_commands.ts:9](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/openclose/openclose_commands.ts#L9)*
...
▸ **execute**(`trait`: [Trait](_models_core_.trait.md), `params`: [OpenClose](../interfaces/_models_traits_i_commands_.openclose.md), `options`: IntentInterface.ExecuteRequestExecutionOption): *Promise‹[ExecuteResult](_models_intent_.executeresult.md)›*

*Overrides [Command](_models_core_.command.md).[execute](_models_core_.command.md#abstract-execute)*

*Defined in [src/models/traits/openclose/openclose_commands.ts:15](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/openclose/openclose_commands.ts#L15)*
...
`params` | [OpenClose](../interfaces/_models_traits_i_commands_.openclose.md) |
...
▸ **getState**(`trait`: [Trait](_models_core_.trait.md)): *object*

*Overrides [Command](_models_core_.command.md).[getState](_models_core_.command.md#abstract-getstate)*

*Defined in [src/models/traits/openclose/openclose_commands.ts:25](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/openclose/openclose_commands.ts#L25)*
...
▸ **setState**(`trait`: [Trait](_models_core_.trait.md), `params`: [OpenClose](../interfaces/_models_traits_i_commands_.openclose.md)): *VariableTrait["States"]*

*Overrides [Command](_models_core_.command.md).[setState](_models_core_.command.md#abstract-setstate)*

*Defined in [src/models/traits/openclose/openclose_commands.ts:51](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/traits/openclose/openclose_commands.ts#L51)*
