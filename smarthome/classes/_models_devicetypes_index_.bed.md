[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Bed](_models_devicetypes_index_.bed.md)
...
* [constructor](_models_devicetypes_index_.bed.md#constructor)

### Properties

* [id](_models_devicetypes_index_.bed.md#id)
* [name](_models_devicetypes_index_.bed.md#name)
* [traits](_models_devicetypes_index_.bed.md#traits)
* [typeName](_models_devicetypes_index_.bed.md#typename)
* [willReportState](_models_devicetypes_index_.bed.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.bed.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.bed.md#createid)
* [getCommand](_models_devicetypes_index_.bed.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.bed.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.bed.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.bed.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.bed.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.bed.md#format)

## Constructors

###  constructor

\+ **new Bed**(`param?`: undefined | object): *[Bed](_models_devicetypes_index_.bed.md)*
...
**Returns:** *[Bed](_models_devicetypes_index_.bed.md)*
...
• **typeName**: *"action.devices.types.BED"* = "action.devices.types.BED"
...
*Defined in [src/models/devicetypes/index.ts:24](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L24)*
