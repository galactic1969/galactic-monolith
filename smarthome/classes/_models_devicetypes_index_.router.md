[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Router](_models_devicetypes_index_.router.md)
...
* [constructor](_models_devicetypes_index_.router.md#constructor)

### Properties

* [id](_models_devicetypes_index_.router.md#id)
* [name](_models_devicetypes_index_.router.md#name)
* [traits](_models_devicetypes_index_.router.md#traits)
* [typeName](_models_devicetypes_index_.router.md#typename)
* [willReportState](_models_devicetypes_index_.router.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.router.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.router.md#createid)
* [getCommand](_models_devicetypes_index_.router.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.router.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.router.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.router.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.router.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.router.md#format)

## Constructors

###  constructor

\+ **new Router**(`param?`: undefined | object): *[Router](_models_devicetypes_index_.router.md)*
...
**Returns:** *[Router](_models_devicetypes_index_.router.md)*
...
• **typeName**: *"action.devices.types.ROUTER"* = "action.devices.types.ROUTER"
...
*Defined in [src/models/devicetypes/index.ts:196](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L196)*
