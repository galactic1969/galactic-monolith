[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Fryer](_models_devicetypes_index_.fryer.md)
...
* [constructor](_models_devicetypes_index_.fryer.md#constructor)

### Properties

* [id](_models_devicetypes_index_.fryer.md#id)
* [name](_models_devicetypes_index_.fryer.md#name)
* [traits](_models_devicetypes_index_.fryer.md#traits)
* [typeName](_models_devicetypes_index_.fryer.md#typename)
* [willReportState](_models_devicetypes_index_.fryer.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.fryer.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.fryer.md#createid)
* [getCommand](_models_devicetypes_index_.fryer.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.fryer.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.fryer.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.fryer.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.fryer.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.fryer.md#format)

## Constructors

###  constructor

\+ **new Fryer**(`param?`: undefined | object): *[Fryer](_models_devicetypes_index_.fryer.md)*
...
**Returns:** *[Fryer](_models_devicetypes_index_.fryer.md)*
...
• **typeName**: *"action.devices.types.FRYER"* = "action.devices.types.FRYER"
...
*Defined in [src/models/devicetypes/index.ts:104](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L104)*
