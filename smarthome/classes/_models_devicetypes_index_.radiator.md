[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Radiator](_models_devicetypes_index_.radiator.md)
...
* [constructor](_models_devicetypes_index_.radiator.md#constructor)

### Properties

* [id](_models_devicetypes_index_.radiator.md#id)
* [name](_models_devicetypes_index_.radiator.md#name)
* [traits](_models_devicetypes_index_.radiator.md#traits)
* [typeName](_models_devicetypes_index_.radiator.md#typename)
* [willReportState](_models_devicetypes_index_.radiator.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.radiator.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.radiator.md#createid)
* [getCommand](_models_devicetypes_index_.radiator.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.radiator.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.radiator.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.radiator.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.radiator.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.radiator.md#format)

## Constructors

###  constructor

\+ **new Radiator**(`param?`: undefined | object): *[Radiator](_models_devicetypes_index_.radiator.md)*
...
**Returns:** *[Radiator](_models_devicetypes_index_.radiator.md)*
...
• **typeName**: *"action.devices.types.RADIATOR"* = "action.devices.types.RADIATOR"
...
*Defined in [src/models/devicetypes/index.ts:188](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L188)*
