[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Heater](_models_devicetypes_index_.heater.md)
...
* [constructor](_models_devicetypes_index_.heater.md#constructor)

### Properties

* [id](_models_devicetypes_index_.heater.md#id)
* [name](_models_devicetypes_index_.heater.md#name)
* [traits](_models_devicetypes_index_.heater.md#traits)
* [typeName](_models_devicetypes_index_.heater.md#typename)
* [willReportState](_models_devicetypes_index_.heater.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.heater.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.heater.md#createid)
* [getCommand](_models_devicetypes_index_.heater.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.heater.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.heater.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.heater.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.heater.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.heater.md#format)

## Constructors

###  constructor

\+ **new Heater**(`param?`: undefined | object): *[Heater](_models_devicetypes_index_.heater.md)*
...
**Returns:** *[Heater](_models_devicetypes_index_.heater.md)*
...
• **typeName**: *"action.devices.types.HEATER"* = "action.devices.types.HEATER"
...
*Defined in [src/models/devicetypes/index.ts:120](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L120)*
