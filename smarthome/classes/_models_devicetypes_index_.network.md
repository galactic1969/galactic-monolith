[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Network](_models_devicetypes_index_.network.md)
...
* [constructor](_models_devicetypes_index_.network.md#constructor)

### Properties

* [id](_models_devicetypes_index_.network.md#id)
* [name](_models_devicetypes_index_.network.md#name)
* [traits](_models_devicetypes_index_.network.md#traits)
* [typeName](_models_devicetypes_index_.network.md#typename)
* [willReportState](_models_devicetypes_index_.network.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.network.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.network.md#createid)
* [getCommand](_models_devicetypes_index_.network.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.network.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.network.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.network.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.network.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.network.md#format)

## Constructors

###  constructor

\+ **new Network**(`param?`: undefined | object): *[Network](_models_devicetypes_index_.network.md)*
...
**Returns:** *[Network](_models_devicetypes_index_.network.md)*
...
• **typeName**: *"action.devices.types.NETWORK"* = "action.devices.types.NETWORK"
...
*Defined in [src/models/devicetypes/index.ts:164](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L164)*
