[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Sprinkler](_models_devicetypes_index_.sprinkler.md)
...
* [constructor](_models_devicetypes_index_.sprinkler.md#constructor)

### Properties

* [id](_models_devicetypes_index_.sprinkler.md#id)
* [name](_models_devicetypes_index_.sprinkler.md#name)
* [traits](_models_devicetypes_index_.sprinkler.md#traits)
* [typeName](_models_devicetypes_index_.sprinkler.md#typename)
* [willReportState](_models_devicetypes_index_.sprinkler.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.sprinkler.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.sprinkler.md#createid)
* [getCommand](_models_devicetypes_index_.sprinkler.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.sprinkler.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.sprinkler.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.sprinkler.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.sprinkler.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.sprinkler.md#format)

## Constructors

###  constructor

\+ **new Sprinkler**(`param?`: undefined | object): *[Sprinkler](_models_devicetypes_index_.sprinkler.md)*
...
**Returns:** *[Sprinkler](_models_devicetypes_index_.sprinkler.md)*
...
• **typeName**: *"action.devices.types.SPRINKLER"* = "action.devices.types.SPRINKLER"
...
*Defined in [src/models/devicetypes/index.ts:232](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L232)*
