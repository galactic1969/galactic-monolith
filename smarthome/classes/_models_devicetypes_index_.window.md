[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Window](_models_devicetypes_index_.window.md)
...
* [constructor](_models_devicetypes_index_.window.md#constructor)

### Properties

* [id](_models_devicetypes_index_.window.md#id)
* [name](_models_devicetypes_index_.window.md#name)
* [traits](_models_devicetypes_index_.window.md#traits)
* [typeName](_models_devicetypes_index_.window.md#typename)
* [willReportState](_models_devicetypes_index_.window.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.window.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.window.md#createid)
* [getCommand](_models_devicetypes_index_.window.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.window.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.window.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.window.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.window.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.window.md#format)

## Constructors

###  constructor

\+ **new Window**(`param?`: undefined | object): *[Window](_models_devicetypes_index_.window.md)*
...
**Returns:** *[Window](_models_devicetypes_index_.window.md)*
...
• **typeName**: *"action.devices.types.WINDOW"* = "action.devices.types.WINDOW"
...
*Defined in [src/models/devicetypes/index.ts:272](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L272)*
