[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Fan](_models_devicetypes_index_.fan.md)
...
* [constructor](_models_devicetypes_index_.fan.md#constructor)

### Properties

* [id](_models_devicetypes_index_.fan.md#id)
* [name](_models_devicetypes_index_.fan.md#name)
* [traits](_models_devicetypes_index_.fan.md#traits)
* [typeName](_models_devicetypes_index_.fan.md#typename)
* [willReportState](_models_devicetypes_index_.fan.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.fan.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.fan.md#createid)
* [getCommand](_models_devicetypes_index_.fan.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.fan.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.fan.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.fan.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.fan.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.fan.md#format)

## Constructors

###  constructor

\+ **new Fan**(`param?`: undefined | object): *[Fan](_models_devicetypes_index_.fan.md)*
...
**Returns:** *[Fan](_models_devicetypes_index_.fan.md)*
...
• **typeName**: *"action.devices.types.FAN"* = "action.devices.types.FAN"
...
*Defined in [src/models/devicetypes/index.ts:92](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L92)*
