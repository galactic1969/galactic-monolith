[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Vacuum](_models_devicetypes_index_.vacuum.md)
...
* [constructor](_models_devicetypes_index_.vacuum.md#constructor)

### Properties

* [id](_models_devicetypes_index_.vacuum.md#id)
* [name](_models_devicetypes_index_.vacuum.md#name)
* [traits](_models_devicetypes_index_.vacuum.md#traits)
* [typeName](_models_devicetypes_index_.vacuum.md#typename)
* [willReportState](_models_devicetypes_index_.vacuum.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.vacuum.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.vacuum.md#createid)
* [getCommand](_models_devicetypes_index_.vacuum.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.vacuum.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.vacuum.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.vacuum.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.vacuum.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.vacuum.md#format)

## Constructors

###  constructor

\+ **new Vacuum**(`param?`: undefined | object): *[Vacuum](_models_devicetypes_index_.vacuum.md)*
...
**Returns:** *[Vacuum](_models_devicetypes_index_.vacuum.md)*
...
• **typeName**: *"action.devices.types.VACUUM"* = "action.devices.types.VACUUM"
...
*Defined in [src/models/devicetypes/index.ts:248](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L248)*
