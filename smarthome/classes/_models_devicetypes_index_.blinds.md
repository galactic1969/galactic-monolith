[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Blinds](_models_devicetypes_index_.blinds.md)
...
* [constructor](_models_devicetypes_index_.blinds.md#constructor)

### Properties

* [id](_models_devicetypes_index_.blinds.md#id)
* [name](_models_devicetypes_index_.blinds.md#name)
* [traits](_models_devicetypes_index_.blinds.md#traits)
* [typeName](_models_devicetypes_index_.blinds.md#typename)
* [willReportState](_models_devicetypes_index_.blinds.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.blinds.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.blinds.md#createid)
* [getCommand](_models_devicetypes_index_.blinds.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.blinds.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.blinds.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.blinds.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.blinds.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.blinds.md#format)

## Constructors

###  constructor

\+ **new Blinds**(`param?`: undefined | object): *[Blinds](_models_devicetypes_index_.blinds.md)*
...
**Returns:** *[Blinds](_models_devicetypes_index_.blinds.md)*
...
• **typeName**: *"action.devices.types.BLINDS"* = "action.devices.types.BLINDS"
...
*Defined in [src/models/devicetypes/index.ts:32](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L32)*
