[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Hood](_models_devicetypes_index_.hood.md)
...
* [constructor](_models_devicetypes_index_.hood.md#constructor)

### Properties

* [id](_models_devicetypes_index_.hood.md#id)
* [name](_models_devicetypes_index_.hood.md#name)
* [traits](_models_devicetypes_index_.hood.md#traits)
* [typeName](_models_devicetypes_index_.hood.md#typename)
* [willReportState](_models_devicetypes_index_.hood.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.hood.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.hood.md#createid)
* [getCommand](_models_devicetypes_index_.hood.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.hood.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.hood.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.hood.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.hood.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.hood.md#format)

## Constructors

###  constructor

\+ **new Hood**(`param?`: undefined | object): *[Hood](_models_devicetypes_index_.hood.md)*
...
**Returns:** *[Hood](_models_devicetypes_index_.hood.md)*
...
• **typeName**: *"action.devices.types.HOOD"* = "action.devices.types.HOOD"
...
*Defined in [src/models/devicetypes/index.ts:124](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L124)*
