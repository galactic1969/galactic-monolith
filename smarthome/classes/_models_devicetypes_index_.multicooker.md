[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Multicooker](_models_devicetypes_index_.multicooker.md)
...
* [constructor](_models_devicetypes_index_.multicooker.md#constructor)

### Properties

* [id](_models_devicetypes_index_.multicooker.md#id)
* [name](_models_devicetypes_index_.multicooker.md#name)
* [traits](_models_devicetypes_index_.multicooker.md#traits)
* [typeName](_models_devicetypes_index_.multicooker.md#typename)
* [willReportState](_models_devicetypes_index_.multicooker.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.multicooker.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.multicooker.md#createid)
* [getCommand](_models_devicetypes_index_.multicooker.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.multicooker.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.multicooker.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.multicooker.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.multicooker.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.multicooker.md#format)

## Constructors

###  constructor

\+ **new Multicooker**(`param?`: undefined | object): *[Multicooker](_models_devicetypes_index_.multicooker.md)*
...
**Returns:** *[Multicooker](_models_devicetypes_index_.multicooker.md)*
...
• **typeName**: *"action.devices.types.MULTICOOKER"* = "action.devices.types.MULTICOOKER"
...
*Defined in [src/models/devicetypes/index.ts:160](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L160)*
