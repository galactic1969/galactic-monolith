[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Refrigerator](_models_devicetypes_index_.refrigerator.md)
...
* [constructor](_models_devicetypes_index_.refrigerator.md#constructor)

### Properties

* [id](_models_devicetypes_index_.refrigerator.md#id)
* [name](_models_devicetypes_index_.refrigerator.md#name)
* [traits](_models_devicetypes_index_.refrigerator.md#traits)
* [typeName](_models_devicetypes_index_.refrigerator.md#typename)
* [willReportState](_models_devicetypes_index_.refrigerator.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.refrigerator.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.refrigerator.md#createid)
* [getCommand](_models_devicetypes_index_.refrigerator.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.refrigerator.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.refrigerator.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.refrigerator.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.refrigerator.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.refrigerator.md#format)

## Constructors

###  constructor

\+ **new Refrigerator**(`param?`: undefined | object): *[Refrigerator](_models_devicetypes_index_.refrigerator.md)*
...
**Returns:** *[Refrigerator](_models_devicetypes_index_.refrigerator.md)*
...
• **typeName**: *"action.devices.types.REFRIGERATOR"* = "action.devices.types.REFRIGERATOR"
...
*Defined in [src/models/devicetypes/index.ts:192](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L192)*
