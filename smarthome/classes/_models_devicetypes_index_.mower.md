[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Mower](_models_devicetypes_index_.mower.md)
...
* [constructor](_models_devicetypes_index_.mower.md#constructor)

### Properties

* [id](_models_devicetypes_index_.mower.md#id)
* [name](_models_devicetypes_index_.mower.md#name)
* [traits](_models_devicetypes_index_.mower.md#traits)
* [typeName](_models_devicetypes_index_.mower.md#typename)
* [willReportState](_models_devicetypes_index_.mower.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.mower.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.mower.md#createid)
* [getCommand](_models_devicetypes_index_.mower.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.mower.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.mower.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.mower.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.mower.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.mower.md#format)

## Constructors

###  constructor

\+ **new Mower**(`param?`: undefined | object): *[Mower](_models_devicetypes_index_.mower.md)*
...
**Returns:** *[Mower](_models_devicetypes_index_.mower.md)*
...
• **typeName**: *"action.devices.types.MOWER"* = "action.devices.types.MOWER"
...
*Defined in [src/models/devicetypes/index.ts:152](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L152)*
