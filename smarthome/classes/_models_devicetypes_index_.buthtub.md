[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Buthtub](_models_devicetypes_index_.buthtub.md)
...
* [constructor](_models_devicetypes_index_.buthtub.md#constructor)

### Properties

* [id](_models_devicetypes_index_.buthtub.md#id)
* [name](_models_devicetypes_index_.buthtub.md#name)
* [traits](_models_devicetypes_index_.buthtub.md#traits)
* [typeName](_models_devicetypes_index_.buthtub.md#typename)
* [willReportState](_models_devicetypes_index_.buthtub.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.buthtub.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.buthtub.md#createid)
* [getCommand](_models_devicetypes_index_.buthtub.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.buthtub.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.buthtub.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.buthtub.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.buthtub.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.buthtub.md#format)

## Constructors

###  constructor

\+ **new Buthtub**(`param?`: undefined | object): *[Buthtub](_models_devicetypes_index_.buthtub.md)*
...
**Returns:** *[Buthtub](_models_devicetypes_index_.buthtub.md)*
...
• **typeName**: *"action.devices.types.BATHTUB"* = "action.devices.types.BATHTUB"
...
*Defined in [src/models/devicetypes/index.ts:20](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L20)*
