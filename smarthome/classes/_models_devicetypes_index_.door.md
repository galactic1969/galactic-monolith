[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Door](_models_devicetypes_index_.door.md)
...
* [constructor](_models_devicetypes_index_.door.md#constructor)

### Properties

* [id](_models_devicetypes_index_.door.md#id)
* [name](_models_devicetypes_index_.door.md#name)
* [traits](_models_devicetypes_index_.door.md#traits)
* [typeName](_models_devicetypes_index_.door.md#typename)
* [willReportState](_models_devicetypes_index_.door.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.door.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.door.md#createid)
* [getCommand](_models_devicetypes_index_.door.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.door.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.door.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.door.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.door.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.door.md#format)

## Constructors

###  constructor

\+ **new Door**(`param?`: undefined | object): *[Door](_models_devicetypes_index_.door.md)*
...
**Returns:** *[Door](_models_devicetypes_index_.door.md)*
...
• **typeName**: *"action.devices.types.DOOR"* = "action.devices.types.DOOR"
...
*Defined in [src/models/devicetypes/index.ts:80](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L80)*
