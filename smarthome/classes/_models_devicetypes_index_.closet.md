[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Closet](_models_devicetypes_index_.closet.md)
...
* [constructor](_models_devicetypes_index_.closet.md#constructor)

### Properties

* [id](_models_devicetypes_index_.closet.md#id)
* [name](_models_devicetypes_index_.closet.md#name)
* [traits](_models_devicetypes_index_.closet.md#traits)
* [typeName](_models_devicetypes_index_.closet.md#typename)
* [willReportState](_models_devicetypes_index_.closet.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.closet.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.closet.md#createid)
* [getCommand](_models_devicetypes_index_.closet.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.closet.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.closet.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.closet.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.closet.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.closet.md#format)

## Constructors

###  constructor

\+ **new Closet**(`param?`: undefined | object): *[Closet](_models_devicetypes_index_.closet.md)*
...
**Returns:** *[Closet](_models_devicetypes_index_.closet.md)*
...
• **typeName**: *"action.devices.types.CLOSET"* = "action.devices.types.CLOSET"
...
*Defined in [src/models/devicetypes/index.ts:52](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L52)*
