[google-smarthome-models](../README.md) › [Globals](../globals.md) › ["models/devicetypes/index"](../modules/_models_devicetypes_index_.md) › [Pergola](_models_devicetypes_index_.pergola.md)
...
* [constructor](_models_devicetypes_index_.pergola.md#constructor)

### Properties

* [id](_models_devicetypes_index_.pergola.md#id)
* [name](_models_devicetypes_index_.pergola.md#name)
* [traits](_models_devicetypes_index_.pergola.md#traits)
* [typeName](_models_devicetypes_index_.pergola.md#typename)
* [willReportState](_models_devicetypes_index_.pergola.md#willreportstate)

### Methods

* [[util.inspect.custom]](_models_devicetypes_index_.pergola.md#[util.inspect.custom])
* [createId](_models_devicetypes_index_.pergola.md#createid)
* [getCommand](_models_devicetypes_index_.pergola.md#getcommand)
* [getMergedAttributes](_models_devicetypes_index_.pergola.md#getmergedattributes)
* [getMergedStates](_models_devicetypes_index_.pergola.md#getmergedstates)
* [getTraitHavingSpecificCommand](_models_devicetypes_index_.pergola.md#gettraithavingspecificcommand)
* [getTraitNames](_models_devicetypes_index_.pergola.md#gettraitnames)

### Object literals

* [format](_models_devicetypes_index_.pergola.md#format)

## Constructors

###  constructor

\+ **new Pergola**(`param?`: undefined | object): *[Pergola](_models_devicetypes_index_.pergola.md)*
...
**Returns:** *[Pergola](_models_devicetypes_index_.pergola.md)*
...
• **typeName**: *"action.devices.types.PERGOLA"* = "action.devices.types.PERGOLA"
...
*Defined in [src/models/devicetypes/index.ts:176](https://github.com/galactic1969/google-smarthome-models/blob/633871f/src/models/devicetypes/index.ts#L176)*
